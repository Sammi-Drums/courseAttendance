...
import StudentDashboard from './app/dashboard/student/StudentDashboard'; //student
import MarkAttendance from './app/dashboard/student/MarkAttendance';
import AttendanceHist from './app/dashboard/student/AttendanceHist';
import LecturerDashboard from './app/dashboard/lecturer/LecturerDashboard'; //lecturer
import LecturerReports from './app/dashboard/lecturer/LecturerReports';
import LiveClass from './app/dashboard/lecturer/LiveClass';
    ...
    <div className="antialiased font-sans">
      <Router>
        <Routes>
          ...
          <Route path="/dashboard/student/history" element={<AttendanceHist />} />

          {/* Lecturer Group */}
          <Route path="/dashboard/lecturer" element={<LecturerDashboard />} />
          <Route path="/dashboard/lecturer/live-class" element={<LiveClass />} />
